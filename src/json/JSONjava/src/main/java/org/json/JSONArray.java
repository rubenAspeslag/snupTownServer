...
public class JSONArray implements Iterable<Object> {
    ...
    public JSONArray(JSONTokener x) throws JSONException {
        this();
        if (x.nextClean() != '[') {
           System.err.println("A JSONArray text must start with '['");
        }
    ...
    public JSONArray(Object array) throws JSONException {
        this();
        if (!array.getClass().isArray()) { throw new JSONException("JSONArray initial value should be a string or collection or array."); }
